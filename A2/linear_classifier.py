  ...
  for i in range(num_train):
    ...
    for j in range(num_classes):
      ...
      if margin > 0:
        ...
        #######################################################################
        # TODO:                                                               #
        # Compute the gradient of the loss function and store it in dW. (part 1) #
        ...
        dW[:, y[i]] -= X[i] # subtract X[i] from the correct class gradient
        dW[:, j] += X[i]    # add X[i] to the incorrect class gradient
        #######################################################################
        #                       END OF YOUR CODE                              #
        #######################################################################
...
def svm_loss_vectorized(W, X, y, reg):
  ...
  loss /= num_train
  loss += reg * torch.sum(W * W)  # add regularization term
  #############################################################################
  #                             END OF YOUR CODE                              #
  #############################################################################
...
def svm_get_search_params():
  ...
  regularization_strengths = [0.0001, 0.0005, 0.001, 0.5]
  ###########################################################################
  #                           END OF YOUR CODE                              #
  ###########################################################################
...
def softmax_get_search_params():
  ...
  regularization_strengths = [0.0005, 0.001, 0.005, 0.01]
  ###########################################################################
  #                           END OF YOUR CODE                              #
  ###########################################################################
